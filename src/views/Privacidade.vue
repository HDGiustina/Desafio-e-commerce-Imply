...
Os compromissos previstos nesta Política de Privacidade serão também abordados e endereçados, conforme aplicável, nas normas e procedimentos de conduta, ética, governança, continuidade do negócio, contratos com prestadores de serviços e fornecedores, de forma a criar um ambiente de observância integral ao comprometimento com a LGPD adotada pela Parquetur nesta Política de Privacidade.

 

Direitos do usuário
O site se compromete a cumprir as normas previstas na LGPD e no RGPD, em respeito aos seguintes princípios:

Os dados pessoais do usuário serão processados de forma lícita, leal e transparente (licitude, lealdade e transparência);
Os dados pessoais do usuário serão coletados apenas para finalidades determinadas, explícitas e legítimas, conforme detalhadas no item 4.3 abaixo, não podendo ser tratados posteriormente de uma forma incompatível com essas finalidades (limitação das finalidades);
...
Os dados pessoais do usuário serão mantidos de forma exata e atualizáveis pelo usuário sempre que entender necessário, de maneira que os dados inexatos possam ser apagados ou retificados pelo usuário ou por solicitação expressa deste sempre que entender necessário (exatidão);
Os dados pessoais do usuário serão conservados de uma forma que permita a identificação dos titulares dos dados apenas durante o período necessário para as finalidades para as quais são tratados (limitação da conservação), conforme detalhadas no item 4.3 abaixo;
...
Direito à eliminação dos dados (direito ao esquecimento): é o direito do usuário de ter seus dados apagados do site, autorizada a retenção de dados para as finalidades legais descritas no art. 16, da LGPD;
...
O usuário poderá exercer os seus direitos por meio de comunicação escrita enviada à pessoa responsável na Parquetur com o assunto "Política de Privacidade - (URL do site)", especificando:
...
O pedido deverá ser enviado ao e-mail: lgpd@parquedaspalmeiras.com.br ou por correio, ao seguinte endereço:

 

Parque das Palmeiras - LGPDParque das Palmeiras

Rua Conceicao, 233 - sala 310
...
A utilização, pelo usuário, de determinadas funcionalidades do site dependerá de cadastro, sendo que, nestes casos, incluindo, mas não se limitando aos seguintes dados do usuário serão coletados e armazenados:
...
4.1.2 Dados informados no formulário ou chat para contato e nas mídias sociais da marca, dados de potenciais fornecedores e potenciais colaboradores.

Os dados eventualmente informados pelo usuário que utilizar o formulário de contato, sistema de chamados de suporte, chat, pesquisas, e-mails e similares, disponibilizado no site, serviços e sistema da Parquetur, incluindo o teor da mensagem enviada, serão coletados e armazenados.

 

4.1.3 Dados relacionados à execução de contratos firmados com o usuário

Para a execução de contrato de compra e venda ou de prestação de serviços eventualmente firmado entre o site e o usuário, poderão ser coletados e armazenados outros dados relacionados ou necessários à sua execução, incluindo o histórico de compras, e o teor de eventuais comunicações tidas com o usuário.
...
dados que revelem as opiniões políticas, as convicções religiosas ou filosóficas, ou a filiação sindical do usuário;
dados genéticos;
...
– dados que revelem a origem racial ou étnica, dados relativos à vida sexual ou à orientação sexual do usuário;

 

4.1.7 Dados de navegação (cookies)
...
4.1.7.1 Cookies do site, serviços e sistemas

Os cookies do site, serviços e sistemas são aqueles enviados ao computador ou dispositivo do usuário e administrador exclusivamente pelo site.
...
4.1.7.2 Cookies de redes sociais
...
4.1.7.3 Gestão dos cookies e configurações do navegador
...
O usuário tem o direito de retirar seu consentimento a qualquer momento, não comprometendo a licitude do tratamento de seus dados pessoais antes da retirada. A retirada do consentimento poderá ser feita pelo e-mail: lgpd@parquedaspalmeiras.com.br, ou por correio enviado ao seguinte endereço:

 

Parque das Palmeiras - LGPD Parque das Palmeiras
...
O consentimento dos relativamente ou absolutamente incapazes, especialmente de menores de 18 (dezoito) anos, apenas poderá ser feito, respectivamente, se devidamente assistidos ou representados.
...
O tratamento de dados pessoais sem o consentimento do usuário apenas será realizado em razão de interesse legítimo, para melhor atendimento às finalidades às quais foram coletados, conforme disposto nesta Política de Privacidade, ou para as hipóteses previstas em lei, ou seja, dentre outras, as seguintes:
...
Os dados pessoais poderão ser utilizados também com uma finalidade comercial, para personalizar o conteúdo oferecido ao usuário, incluindo ofertas personalizadas de produtos, preços e/ou condições de pagamento, bem como para dar subsídio ao site para a melhora da qualidade e funcionamento de seus serviços.

 

Também utilizamos os dados cadastrais para entrar em contato com você, quando necessário. Esse contato pode contemplar diversos assuntos, como comunicação sobre promoções e ofertas, respostas a dúvidas, respostas de reclamações e solicitações, atualizações dos pedidos realizados e informações de entrega.
...
Tempo que o usuário for cliente da empresa
...
Os dados pessoais do usuário poderão ser compartilhados com pessoas ou empresas terceiras para a finalidade de melhorar a experiência de serviço de compra e de pós compra para o usuário; validar a autenticidade e revogação de Certificados Digitais; para geração da cronologia de uma transação; para processamentos financeiros, contábeis e de TI e para envios periódicos de comunicação da empresa.
...
Neste site, o responsável pelo tratamento dos dados pessoais coletados é Parque das Palmeiras Participações S.A., representada por Helena Della Giustina Aguiar que poderá ser contactado pelo e-mail: lgpd@parquedaspalmeiras.com.br ou no endereço:
...
Por fim, o site, serviços e sistemas, se comprometem a tratar os dados pessoais do usuário com confidencialidade, dentro dos limites legais.
...
Das alterações
Esta Política de Privacidade foi atualizada pela primeira vez em conformidade com a LGPD e a RGDP em 10 de setembro de 2.020.

A presente versão desta Política de Privacidade foi atualizada pela última vez em: 02 de fevereiro de 2.021.

O editor se reserva o direito de modificar, a qualquer momento, o site as presentes normas, especialmente para adaptá-las às evoluções do site Parquetur, seja pela disponibilização de novas funcionalidades, seja pela supressão ou modificação daquelas já existentes.
...
Os eventuais litígios deverão ser apresentados no foro da comarca em que se encontra a sede do editor do site.</h5>
            </div>
