            ...
            <div class="uk-modal-dialog uk-modal-body">
                ...
                <div class="uk-padding-medium">
                    <form  @submit.prevent="enviarDados">
                        ...
                        <input class="uk-input" type="text" name="fullname" id="fullname">
                        ...
                        <input type="text" class="uk-input" name="phone" id="phone">
                        ...
                        <input type="text" name="repeat_password" id="repeat_password" class="uk-input">
                        <button type="submit" class="uk-button uk-margin uk-align-center uk-background-primary uk-text-secondary uk-box-shadow-hover-large">Cadastrar</button>
                    </form>
                </div>
            </div>
        </div>
